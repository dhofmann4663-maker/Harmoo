...
export default function App() {
  ...
  <PieChart width={400} height={400}>
    ...
    <h2>🐕 Mission</h2><p>
      ...
      </p><h2>💡 How to Buy</h2><ol style={{ textAlign: 'left', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <><h2>💙 Charity Transparency</h2><p>
    We believe in full transparency. Donations go directly to support <strong>Noah’s Hope Animal Rescue</strong>.
  </p><p style={{ fontFamily: 'monospace', color: '#2563EB', wordBreak: 'break-word' }}>
      YOUR_CHARITY_WALLET_ADDRESS_HERE
    </p></>

      {/* Social Links Section */}
      <><h2>🌐 Join the Community</h2><p>Follow us and become part of the Harmoonian family 🚀🐾</p><div style={{ marginTop: '1rem', display: 'flex', justifyContent: 'center', gap: '1rem' }}>
  ...
  </div><footer style={{ marginTop: '2rem', fontSize: '0.9rem', color: '#555' }}>
